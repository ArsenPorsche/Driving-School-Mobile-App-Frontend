...
const Store = ({ navigation, tokenRole }) => {
  ...
  return (
    <View style={storeStyles.container}>
      <ScrollView contentContainerStyle={storeStyles.scrollContent}>
        ...
        {loading ? (
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <StoreItem item={item} onAdd={handleAdd} />
            )}
            scrollEnabled={false}
            ItemSeparatorComponent={() => (
              <View style={storeStyles.separator} />
            )}
      ...
      <TouchableOpacity
        style={storeStyles.floatingCart}
